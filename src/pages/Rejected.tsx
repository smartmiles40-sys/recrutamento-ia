...
export default function Rejected() {
  ...
  return (
    <AppLayout>
      <div className="mb-8">
        <h1 className="font-display text-3xl font-bold text-foreground">Reprovados</h1>
        <p className="mt-1 text-sm text-muted-foreground">Candidatos que foram reprovados no processo seletivo</p>
      </div>
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        <span className="ml-auto rounded-lg bg-destructive/10 px-3 py-1.5 text-xs font-semibold text-destructive">
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-border bg-card p-12 text-center shadow-card">
          ...
          <p className="mt-3 text-sm font-medium text-muted-foreground">Nenhum candidato reprovado</p>
        </div>
      ) : (
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-destructive/10 font-display text-sm font-bold text-destructive">
                  ...
                  <div className="text-right">
                    ...
                    <span className="inline-block rounded-md bg-destructive/10 px-1.5 py-0.5 text-[10px] font-semibold text-destructive">
                      Reprovado
                    </span>
                  </div>
                </div>
